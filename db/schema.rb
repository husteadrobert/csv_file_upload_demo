...
ActiveRecord::Schema[7.1].define(version: 2025_10_10_122830) do
  ...
  create_table "building_csv_files", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "buildings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["unique_assigned_id"], name: "index_buildings_on_unique_assigned_id", unique: true
  end
